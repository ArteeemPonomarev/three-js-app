...
var mapOptions = {
  ...
  "zoom": 20,
  "center": {
    lat: 41.406704711892924,
    lng: 2.1615649441710687
  },
...
function _initMap() {
  _initMap = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var mapDiv, apiLoader;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            mapDiv = document.getElementById("map");
            apiLoader = new Loader(apiOptions);
            _context2.next = 4;
            return apiLoader.load();
          case 4:
            return _context2.abrupt("return", new google.maps.Map(mapDiv, mapOptions));
          case 5:
          case "end":
...
function initWebGLOverlayView(map) {
  var scene, renderer, camera, loader;
  ...
  webGLOverlayView.onAdd = function () {
    ...
    var ambientLight = new THREE.AmbientLight(0xffffff, 0.75); // soft white light
    ...
    var source = "./assets/models/uploads_files_3688322_one_living_room.glb";
  ...
  webGLOverlayView.onContextRestored = function (_ref) {
    var gl = _ref.gl;
    // create the three.js renderer, using the
    // maps's WebGL rendering context.
    renderer = new THREE.WebGLRenderer(_objectSpread({
      canvas: gl.canvas,
      context: gl
  ...
  webGLOverlayView.onDraw = function (_ref2) {
    var gl = _ref2.gl,
